...
cd C:\Users\welcam\Desktop\razaq\WIDHYA_Internship\Artificial-Neural-Network-master\csv files\sin_csv
...
class ANN(object):
    ...
    def plot_weights_over_epochs(self):
        ii = len(self.parameters)//2
        for i in range(0, ii):
           # plt.title("W" + str(i+1) +" over epochs",'ro')
